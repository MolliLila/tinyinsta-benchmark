...
DIR_OUTPUT = "../out/"
CSV_FILE = os.path.join(DIR_OUTPUT, "fanout_summary.csv")
OUTPUT_FILE = os.path.join(DIR_OUTPUT, "fanout.png")
...
def plot_conc(show=False):
    ...
    plt.xlabel("Nombre de posts par followee")
    plt.ylabel("Temps moyen par requête (secondes)")
    plt.title("Temps moyen par requête selon le nombre de followee par utilisateur")
